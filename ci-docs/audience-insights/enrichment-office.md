...
- Teie Customer Insightsi keskkonnas peab olema [Microsoft Dataverse seostatud organisatsioon](create-environment.md#step-3-connect-to-microsoft-dataverse).
