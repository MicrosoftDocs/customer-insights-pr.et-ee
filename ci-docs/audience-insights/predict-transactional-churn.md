...
> [!TIP]
> Proovige õpetust tehingu churn prognoos kasutades näidisandmeid: [Transaction churn prognoos näidisjuhend](sample-guide-predict-transactional-churn.md).
...
1. **Valige kliendi churn mudeli** paan ja valige **Kasuta seda mudelit**.
